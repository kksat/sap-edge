...
| source_image            | The image name for the disk for the VM instance.       | `string`       | `"projects/mpi-redhat-marketplace-public/global/images/redhat-coreos-ocp-413-x86-64-202305021736"` | no       |
...
| boot_disk_size          | The boot disk size for the VM instance in GBs          | `number`       | `16`                                                                                               | no       |
